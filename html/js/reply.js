    ...
    $("#additionalPersons").on('change', function () {
        ...
        if (persons > 0 ) {
            ...
            for (i = 0; i < persons; i++) {
                ...
                $("#extraPersons").append("<div class='form-group'> <div class='col-sm-4'> <input type='name' id = 'person" + (i + 2) + "'class='form-control' placeholder='Gjest " + (i + 2) + "'> </div>" +
                    " <div class='col-sm-3'><select class = 'form-control' id = '" + sleepoverid + "'>" +
                    "<option value = 0>-- Skal han/hun overnatte? --</option>" +
                    "<option value = ja>Ja</option>" +
                    "<option value = nei>Nei</select></div></div>")
